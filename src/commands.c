...
/* NDS history */
#define NDS_History NULL

/* NDS tips */
#define NDS_tips NULL
...
{"nds","Naive Data Store commands","Depends on subcommand.","2.6.0",CMD_DOC_NONE,NULL,NULL,COMMAND_GROUP_SERVER,NDS_History,NDS_tips,NULL,-2,0,0},
